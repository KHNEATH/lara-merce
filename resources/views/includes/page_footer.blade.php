        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Chipmong Grand Phnom Penh</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>Info@LyHeangCatering.com</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>10% Off Your Next Visit : Show this email to your server to receive 10% off your next meal. Valid until November 30.</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Copyright 2024 - Ly Heang Catering</a>, All Right Reserved.
